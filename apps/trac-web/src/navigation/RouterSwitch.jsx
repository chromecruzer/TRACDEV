...
import {OpenAuditsTest} from "../pages/OpenAuditsTest";
import AuditUpload from "../pages/AuditUpload";
import {Products} from "../pages/Products";
import {SalesReps} from "../pages/SalesReps";
import {SalesRepsTest} from "../pages/SalesRepsTest";
  ...
  return (
    <DebugRouter>
      <Routes>
		...
		<Route path={pageMappings['Open Audits Test']} element={<OpenAuditsTest/>}/>
		...
		<Route path={pageMappings['Sales Reps Test']} element={<SalesRepsTest/>}/>
